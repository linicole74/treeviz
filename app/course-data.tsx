...
const firebaseConfig = {
    ...
    appId: "1:702893689283:web:6630133e93501b36c21576"
  };
...
export const getPreReqs = async () => {
    ...
    col.forEach((course:any) => {
        ...
        courses.push({identifier: courseData.identifier, prereqs: courseData.prerequisites})
    })
    ...
    courses.forEach((course:any) => {
        ...
        if (course.prereqs){
            ...
            const finalPreReqString = preReqString.substring(0, preReqString.length - (preReqType.length + 2)) 
