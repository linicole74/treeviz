export const coursePrefixes = "ACCT AE AS APPH ASE ARBC ARCH BIOS BIOL BMEJ BMED BMEM BC BCP CETL CHBE CHEM CHIN CP CEE COA COE COS CX CSE CS COOP UCGA EAS ECON ECEP ECE ENGL FC FREE FREN GT GTL GRMN HS HEBW HIN HIST HTS HUM ID ISYE INTA IL INTN IMBA IAC JAPN KOR LATN LS LING LMC MGT MOT MLDR MSE MATH ME MP MSL ML MUSI NS NEUR NRE PERS PHIL PHYS POL PTFE PORT DOPP PSYC PUBJ PUBP RUSS SCI SLS SS SOC SPAN SWAH VIP WOLO";
